...
alias performance='sudo tuned-adm profile hpc-compute'
alias profile='sudo tuned-adm active'
alias ff='clear && fastfetch'
alias e3='sudo vim ~/.config/i3/config'
alias list='sudo apt list --upgradable'
alias kvm-network='sudo virsh net-start default'
...
PS1="${MAGENTA}\t ${GREEN}\u ${WHITE}@ ${YELLOW}\h${RED}${ssh_message} ${WHITE}in ${BLUE}\w ${CYAN}\$${ENDC} "
